...
public class MatrixMultiplication {
    ...
    static void arrayProduct(int[][]arr,int r1,int c1,int[][]brr,int r2,int c2){
        if(c1!=r2){
            System.out.println("error:matrix can not be multiplied");
            return;
        }
    ...
    public static void main(String[] args) {
        ...
        arrayProduct(array,r1,c1,brray,r2,c2);
    }
}
